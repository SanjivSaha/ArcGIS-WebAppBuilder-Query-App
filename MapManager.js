...
define([
  ...
  LayerInfos, Message, AppStatePopup, arrayUtils, MapUrlParamsHandler, AppStateManager, PopupManager, FilterManager) {
  var instance = null,
    clazz = declare(null, {
      appConfig: null,
      mapDivId: '',
	...
	/*************************Load layers dynamically********************************/ 
	 var layerUrl,layerListOpt="", visible = [];   //https://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Specialty/ESRI_StatesCitiesRivers_USA/MapServer
	 var layer1 = new esri.layers.ArcGISDynamicMapServiceLayer("http://10.1.4.36:6443/arcgis/rest/services/NMPT_GIS_Inputdata/MapServer"); //Pay attention
	 layer1.on("load",buildLayerList);
         map.addLayer(layer1);
	 layer1.setVisibleLayers(visible);
		
	 function buildLayerList(){
	     var items = arrayUtils.map(layer1.layerInfos, function(info, index) {
